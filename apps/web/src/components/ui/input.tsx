  ...
  (
    ...
    return (
      <div className="w-full">
        ...
        {error ? (
          <p className="mt-1.5 animate-slide-down text-sm text-destructive">{error}</p>
        ) : hint ? (
      ...
      <Input
        ...
        rightIcon={
          <button
            ...
            className="rounded p-1 text-muted-foreground transition-colors hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            tabIndex={-1}
          >
            {showPassword ? (
